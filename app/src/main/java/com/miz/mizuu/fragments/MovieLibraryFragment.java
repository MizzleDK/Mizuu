...
public class MovieLibraryFragment extends Fragment implements OnNavigationListener, OnSharedPreferenceChangeListener {
    ...
    private int mImageThumbSize, mImageThumbSpacing, mType, mCurrentSort;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MovieLoader loader = new MovieLoader(getActivity(), MovieLibraryType.ALL_MOVIES, callback);
        loader.load();
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mType == OTHER)
            getActivity().setTitle(R.string.chooserWatchList);
        else
    ...
    LoaderCallbacks<Cursor> loaderCallbacks = new LoaderCallbacks<Cursor>() {
        ...
        public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
            ...
            return new SQLiteCursorLoader(getActivity(), DatabaseHelper.getHelper(getActivity()).getWritableDatabase(), DbAdapterMovies.DATABASE_TABLE,
                    DbAdapterMovies.SELECT_ALL, null, null, null, null, null);
        }
        ...
        public void onLoadFinished(Loader<Cursor> arg0, final Cursor cursor) {
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    ...
                    Log.d("MIZUU", "SIZE: " + mMovieKeys.size());
    ...
    private void showDetails(int arg2, View view) {
    ...
    private class LoaderAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            mPicasso.load(mCollectionsView ? mMovie.getCollectionPoster() : mMovie.getThumbnail()).config(mConfig).into(holder);
    ...
    private void sortMovies() {
        ...
        String SORT_TYPE = mSharedPreferences.getString((((ActionBarActivity) getActivity()).getSupportActionBar().getSelectedNavigationIndex() == COLLECTIONS) ? SORTING_COLLECTIONS_OVERVIEW : SORTING_MOVIES, "sortTitle");
    ...
    public void sortBy(int sort) {
        ...
        boolean isCollection = ((ActionBarActivity) getActivity()).getSupportActionBar().getSelectedNavigationIndex() == COLLECTIONS;
    ...
    private class ActionBarSpinner extends BaseAdapter {
        ...
        public ActionBarSpinner() {
            mInflater = LayoutInflater.from(((ActionBarActivity) getActivity()).getSupportActionBar().getThemedContext());
        }
