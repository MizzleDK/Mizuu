...
public class NewTvShowsLibraryUpdate extends IntentService implements TvShowLibraryUpdateCallback {
	...
	public NewTvShowsLibraryUpdate() {
		super("TvShowsLibraryUpdate");
	}

	public NewTvShowsLibraryUpdate(String name) {
		super(name);
	}
