 ...
 */
public abstract class MovieSectionAsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = com.miz.functions.MizLib.hasHoneycomb() ? new SerialExecutor() :
     ...
     *         {@link MovieSectionAsyncTask.Status#RUNNING} or {@link MovieSectionAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final MovieSectionAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final MovieSectionAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
		...
		final MovieSectionAsyncTask mTask;
        final Data[] mData;

        @SuppressWarnings("rawtypes")
		AsyncTaskResult(MovieSectionAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
