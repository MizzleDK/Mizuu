...
public class UnidentifiedFiles extends Activity {
	...
	private void loadData() {
		...
		enableNoFilesMessage(episodes.size() == 0);
	}
		...
		case R.id.remove_all:
			...
			.setPositiveButton(getString(android.R.string.yes), new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					DbAdapterTvShow dbTvShow = MizuuApplication.getTvDbAdapter();
	...
	private class ListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.name.setText(episodes.get(position).getTitle());
			holder.size.setText(episodes.get(position).getFilepath());
